  ...
  <div class="foot">
    <div class="border-bottom border-top bg-navcolor">
      <div class="d-flex py-6 jc-center">
        <div class="px-7 hand">
          <a
            href="https://github.com/zzzlight"
            target="_blank"
            class="text-grey-1"
          >
            GITHUB
        ...
        <div class="px-7 hand">
          <a href="https://twitter.com" class="text-grey-1">TWITTER</a>
        </div>
      </div>
    </div>
        ...
        <div class="px-8 mb-4">
          ...
          <div class="text-grey-2 fs-sm">
            ...
            <p>
              ...
              <a href="https://github.com/zzzlight" target="_blank">
                zzzlight
              </a>
            </p>
            <p>
